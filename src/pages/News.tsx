...
const MOCK_US: NewsItem[] = [
  {
    title:       'S&P 500 Climbs as Tech Earnings Beat Expectations',
    link:        '#',
    description: 'The S&P 500 index rose 0.8% as major technology companies reported first-quarter earnings that exceeded Wall Street forecasts, led by strong cloud computing and AI-related revenue growth.',
    pubDate:     new Date(Date.now() - 2 * 3600000).toUTCString(),
    source:      'MarketWatch',
  },
  {
    title:       'Fed Holds Rates Steady, Signals Cautious Path Forward',
    link:        '#',
    description: 'The Federal Reserve kept its benchmark interest rate unchanged and indicated it would need to see further progress on inflation before considering rate cuts, as policymakers weigh resilient job gains against persistent price pressures.',
    pubDate:     new Date(Date.now() - 4 * 3600000).toUTCString(),
    source:      'Reuters',
  },
  {
    title:       'NVIDIA Reports Record Data Center Revenue, AI Demand Surges',
    link:        '#',
    description: 'NVIDIA posted record quarterly revenue driven by insatiable demand for its AI chips. Data center segment revenue surged, as hyperscalers continue massive capital expenditure programs for AI infrastructure.',
  ...
  },
  {
    ...
    link:        '#',
    description: 'U.S. Treasury yields climbed after a stronger-than-expected jobs report reinforced expectations that the Federal Reserve will remain patient before cutting interest rates. The 10-year yield topped 4.5%.',
    pubDate:     new Date(Date.now() - 7 * 3600000).toUTCString(),
    source:      'MarketWatch',
  },
  {
    title:       'Apple Plans Major AI Features for iOS 19 Unveiled at WWDC',
    link:        '#',
    description: 'Apple announced a suite of generative AI features for its upcoming iOS 19 release, including on-device large language model capabilities and deep Siri integration, marking its most significant software update in years.',
    pubDate:     new Date(Date.now() - 9 * 3600000).toUTCString(),
    source:      'Reuters',
  },
  {
    title:       'Microsoft Azure Growth Accelerates, Beats Quarterly Revenue Estimates',
    link:        '#',
    description: 'Microsoft reported accelerating growth in its Azure cloud platform, with revenue growth driven by AI services adoption. The company raised its full-year revenue outlook citing expanding enterprise demand for AI workloads.',
    pubDate:     new Date(Date.now() - 11 * 3600000).toUTCString(),
    source:      'CNBC Markets',
  },
  {
    title:       'Oil Prices Slide on Rising US Inventory Data',
    link:        '#',
    description: 'Crude oil futures fell after the EIA reported a surprise build in US crude inventories, raising concerns about demand strength even as OPEC+ maintained its production cut strategy through mid-year.',
    pubDate:     new Date(Date.now() - 13 * 3600000).toUTCString(),
    source:      'Investopedia',
  },
  {
    title:       'Dollar Weakens Against Yen as BOJ Policy Shift Expectations Rise',
    link:        '#',
    description: 'The U.S. dollar slipped against the Japanese yen as traders increased bets that the Bank of Japan would raise interest rates at its next policy meeting, citing improving wage growth and above-target inflation.',
    pubDate:     new Date(Date.now() - 15 * 3600000).toUTCString(),
    source:      'Reuters',
  },
  {
    title:       'Nasdaq 100 ETF Sees Record Weekly Inflows Amid AI Optimism',
    link:        '#',
    description: 'Investors poured a record amount into Nasdaq 100-tracking ETFs as artificial intelligence enthusiasm continued to drive risk appetite, with semiconductor and software companies leading the rally.',
    pubDate:     new Date(Date.now() - 18 * 3600000).toUTCString(),
    source:      'Investopedia',
  },
  {
    title:       'Consumer Confidence Index Dips Slightly in April Survey',
    link:        '#',
    description: 'The Conference Board Consumer Confidence Index edged lower in April, with respondents citing inflation concerns and uncertainty about the job market, though the reading remained above long-term averages.',
