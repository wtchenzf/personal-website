...
const SMART_MONEY: SmartMoneyStock[] = [
  ...
  },
  {
    ...
    note: 'AI 資料中心液冷散熱龍頭，Google、AWS 大單在手。投信與外資罕見同步連買 17 日，05/15 液冷散熱族群同步走強 +1.39% 收 2,555，屬獲利回吐正常拉回，籌碼極乾淨，多頭結構未破。',
  },
  {
    code: '2330', name: '台積電',    sector: '半導體製造',
    price: 2335,  changePct: +0.64,
    foreignDays: 16, trustDays: 10, dealerDays: 0,
    netBuyK: 38600, volRatio: 1.4, pricePct: 35.8,
    signal: 91,
    tags: ['外資連買15日', 'CoWoS 滿載', 'N2 順利量產', '指標龍頭'],
    note: '外資近 16 日累積回補超過 4.1 萬張，CoWoS 封裝需求持續炸單，N2 良率優於預期。05/15 外資持續布局 +0.64% 收 2,335，長期法人布局態度不變，外資持續加碼。',
  },
  {
  ...
  },
  {
    ...
    note: 'ABF 載板龍頭，CoWoS 先進封裝帶動 ABF 需求爆發。外資連 13 日買超，05/15 延續漲勢 +1.87% 收 925，主動 ETF 00981A 持續加碼，中長線布局訊號明確，量能穩健。',
  },
  {
    ...
    note: '液冷散熱冷排零組件，受惠 AI 伺服器機架液冷趨勢。主動 ETF 00981A / 00992A 均持有，籌碼被鎖。05/15 再漲 +3.74% 收 222，突破整數關卡，小股本彈性大，動能持續強勁。',
  },
  {
    code: '2454', name: '聯發科',    sector: 'IC 設計',
    price: 4230,  changePct: +1.93,
    foreignDays: 11, trustDays: 8,  dealerDays: 0,
    netBuyK: 18700, volRatio: 1.2, pricePct: 58.7,
    signal: 67,
    tags: ['外資連買10日', 'AI手機', 'Dimensity旗艦', '法說會催化'],
    note: '外資回補 10 日，Dimensity 9400+ 拿下三星、vivo 旗艦，AI 手機滲透率加速。05/04-05 連續漲停爆發後持續走強，05/15 上漲 +1.93% 收 4,230，短期飆升動能強勁，創波段新高。',
  },
  {
