...
const FLOW_DATA: Record<string, { ohlc: (OHLCBar & { volume: number })[]; chips: ChipBar[] }> = (() => {
  ...
  d['3661'] = buildFromReal(b3661, 1.5, 8, 500, 3661, { 31: 319, 32: 147, 33: -672, 34: 239, 35: 323 });
  ...
  d['3017'] = buildFromReal(b3017, 12, 8, 700, 3017, { 31: 373, 32: -352, 33: 1412, 34: -860, 35: -498 });
  ...
  d['6669'] = buildFromReal(b6669, 5, 8, 500, 6669, { 31: 38, 32: -339, 33: -250, 34: -9, 35: 431 });
  ...
  d['3653'] = buildFromReal(b3653, 3, 8, 450, 3653, { 30: -750, 35: 87 }); // 05/08 大賣超；05/15 玩股網實測
  ...
  d['3037'] = buildFromReal(b3037, 30, 8, 3500, 3037, { 31: 3913, 32: 3442, 33: 2448, 34: 215, 35: -8011 }); // 05/11-14 大量買超後 05/15 法人大賣
  ...
  d['3711'] = buildFromReal(b3711, 33, 8, 3200, 3711, { 25: -380, 33: -1292, 34: -1285, 35: 1353 }); // 04/30 小幅減碼；05/13-15 玩股網實測
  ...
  d['8996'] = buildFlowData(
    ...
    7, 8, 600, 0.030, 8996,
    { 31: -120, 32: -156, 33: -231, 34: 88, 35: 32 }  // 05/11-15 玩股網實測（外資全週賣，投信買）
  );
...
const SMART_MONEY: SmartMoneyStock[] = [
  ...
  },
  {
    ...
    note: '全球最大 OSAT，SiP 封裝持續受惠 AI 需求，外資逢低回補已達 11 日，05/15 延續 +1.24% 收 572，連續兩日走強，本益比相較同業偏低，防禦性佳，長線布局價值顯現。',
  },
];
